...
import { fetchEflMarketOdds, type EflCompetition, type MarketOddsTeamRow } from "@/lib/eflMarketOdds";
...
export default async function EflMarketOddsPage({
  ...
  const { fixtures, top5Winners, top5Goals, top5CleanSheets } = await fetchEflMarketOdds(viewedGameweek, activeCompetition);
