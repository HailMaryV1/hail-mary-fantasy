...
import TeamStrengthGrid from "./TeamStrengthGrid";
    ...
    <div className="min-h-screen bg-navy-950 px-4 py-6 sm:px-6">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-1 text-sm text-navy-300">
          ...
          before real bookmaker odds are posted for a fixture - once they land, real odds always win. Separate
          Home/Away ratings - tick Override to set them, untick and save to revert to the automated baseline shown
          underneath.
        </p>

        <div className="mt-6">
          <TeamStrengthGrid initialRows={rows} />
        </div>
      </div>
    </div>
  );
