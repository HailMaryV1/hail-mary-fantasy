...
import type { GameweekPlanStep, BundleTransfer } from "@/lib/cloudffAskMaryEngine";
 ...
 * full plan is 3 of these stacked. Own copy (not shared with the other
 * games') per this app's per-game independent identity rule. Cost is
 * never shown per-leg here (Cloud FF transfers are always free), unlike
 * Dream Team/FanTeam's rows.
 */
            ...
            <>
              ...
              <div className="mt-3 rounded-lg border border-navy-800 bg-navy-950 p-3">
                ...
                <p className="mt-1 text-sm text-navy-200">
                  £{(Math.abs(step.budgetRemainingAfter) < 0.05 ? 0 : step.budgetRemainingAfter).toFixed(1)}m in the bank · {step.resultingSquadExpectedPoints.toFixed(1)} pts projected for GW{step.gameweek}
                </p>
              </div>
