// Dream Team's 3 season Boosters (rules section 1.2.5.8) - each evaluated
// as "how many extra points would this gameweek's starting XI be
// projected to score if I activated this booster now," using the same
 ...
 */
export function evaluateTwelfthMan(poolCandidates: PoolProjection[], startingXIIds: Set<number>): { gain: number; reasoning: string; best: PoolProjection | null } {
