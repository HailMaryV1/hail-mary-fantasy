...
type PoolRow = {
  ...
  // The 1-10 Hail Mary Rating (migration 0135) - already returned by this
  // file's own select("*") on game_player_pool, just wasn't in this local
  // type shape until now. See transferMatching.ts's TransferCandidate.rating
  // for how it's threaded onward from here.
