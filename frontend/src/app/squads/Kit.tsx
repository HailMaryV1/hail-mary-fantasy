...
// colors carries no licensing risk (see the plan this was built from for
// why we're not using FanTeam's own kit artwork).
const JERSEY_PATH =
  "M35 12 L22 22 L8 30 L18 42 L30 32 L30 92 L70 92 L70 32 L82 42 L92 30 L78 22 L65 12 Q50 26 35 12 Z";

// Tailwind classes, not fixed pixel width/height attributes - needs to
// shrink at the same breakpoints the pitch chip itself does (w-14 sm:w-20
// md:w-24 in PitchView.tsx), otherwise a fixed-size kit overflows the
// smallest chip width on mobile (caught by checking scrollWidth vs
// clientWidth directly, not just eyeballing it).
const SIZE_CLASSES = {
  sm: "h-5 w-5",
