...
/**
 * Client-side filter over the whole player list (a few hundred rows for
 * either game - small enough to ship once and filter locally rather than
 * round-tripping on every keystroke). Works for ANY player in the
 * selected game, per the point of this page.
 */
export default function PlayerSearch({
  ...
  function selectPlayer(gamePlayerId: number) {
    setQuery("");
    router.push(`/algorithm-explain?game=${gameSlug}&player=${gamePlayerId}`);
  }
