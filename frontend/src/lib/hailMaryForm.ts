...
// calls - same "service, not embedded-in-JSX" pattern as
// performanceAnalytics.ts. Every page that needs a badge calls
// buildFormByGamePlayerId() once over its own fetched rows.
...
): { average: number | null; gamesUsed: number } {
